...
class TestBitmex(Test, Bitmex):
    ...
    def test_BTC_USD_full(self):
        origin = {
            'FileName': 'full.gz',
            'Date': '2018/08/23',
        }
        self.initialization('BTC/USD', 'update', origin['Date'])
    ...
    def test_ETH_USD_orderbook10(self):
        origin = {
            'FileName': 'ETH_USD-bitmex_order.gz',
            'Date': '2018/08/08',
            'Output': 'ETH_USD-bitmex.book.csv.gz',
        }
